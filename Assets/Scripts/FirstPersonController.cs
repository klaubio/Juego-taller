...
namespace StarterAssets
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		public int damage;
		private int damageDefault = 20;
		[Tooltip("Sprint speed of the character in m/s")]
		public float SprintSpeed;
		private float defaultSprintSpeed = 12f;
		...
		[Header("Audio Clips")]
         ...
         public AudioClip jumpSound; // Nueva variable para el sonido de salto
		...
		{
			sprinttext.text = SprintSpeed.ToString();
			walktext.text = moveSpeed.ToString();
		}
        public void Attack()
        {
            ...
            // Otras acciones de ataque aquí (si es necesario)
        }
